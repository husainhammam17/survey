...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td><a href='../admin/includes/pasar_pahing.php?action=validasi&id=" . $row['id_barang'] . "'>Validasi</a> | <a href='?action=edit&id=" . $row['id_barang'] . "&source=edit_pahing'>Edit</a></td>";
        echo "</tr>";
    }
    echo "</table>";
    echo "</div>";
